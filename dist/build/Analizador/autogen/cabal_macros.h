...
/* package Analizador-0.1.0.0 */
#ifndef VERSION_Analizador
#define VERSION_Analizador "0.1.0.0"
#endif /* VERSION_Analizador */
#ifndef MIN_VERSION_Analizador
#define MIN_VERSION_Analizador(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Analizador */
...
#define CURRENT_COMPONENT_ID "Analizador-0.1.0.0-JumLh69Ob6xIx2JTcNtDJY-Analizador"
